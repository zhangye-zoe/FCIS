# dataset settings
dataset_type = 'FCISLiverCellDataset'
data_root = '/mnt/eternus/users/Ye/LiverCell/data256/mmseg'
train_processes = [
    ...
    dict(type='Formatting', data_keys=['img'], label_keys=['sem_gt', 'sem_gt_inner', 'loss_weight_map', 'inst_gt' ])
]
test_processes = [
    dict(type='Resize', scale_factor=2, resize_mode='scale'),
    dict(
